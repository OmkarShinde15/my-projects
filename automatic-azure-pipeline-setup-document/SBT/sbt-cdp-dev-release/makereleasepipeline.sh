      ...
      "deployPhases": [
        {
          "deploymentInput": {
            ...
            "tags": [     
              "'"$STAGE1_DEPLOYMENT_TAG"'"     //Tags inside CDP_DEV deployment group
            ],
            ...
            "queueId": '"$STAGE_DEPLOYMENT_GRP_ID"',     //CDP_DEV deployment group id
            "demands": [
